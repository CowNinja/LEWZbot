...
Reload_MEmu()
{
	...
	Gui, Status:add,text,, MEmu reloading... loop, %Main_Loop_Counter%
...
Launch_LEWZ()
{
	...
	OCR_W := 140
	OCR_H := 42
	LL_Icon01 := Search_Captured_Text_OCR(Search_Captured_Text, {Pos: [OCR_X, OCR_Y], Size: [OCR_W, OCR_H], Timeout: 0})
	OCR_X := 7
	OCR_Y := 880
	OCR_W := 140
	OCR_H := 42
