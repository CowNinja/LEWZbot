...
Switch_Account:
{
	...
	loop, 5
	{
		; Search_Captured_Text := OCR([287, 676, 200, 55], "eng") ; "WarZ Account" button
		...
		; Search_Captured_Text := OCR([419, 1140, 130, 37], "eng") ; "Other Account" button
		...
		; Search_Captured_Text := OCR([374, 719, 160, 40], "eng") ; "Use your email" button
