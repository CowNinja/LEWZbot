### copied from [Ruby on Rails contributing document](https://raw.githubusercontent.com/rails/rails/main/CONTRIBUTING.md)
* I like the short and concise format. I'll edit details later... ;)
...
## How to contribute to LEWZbot

#### **Did you find a bug?**

* **Do not open up a GitHub issue if the bug is a security vulnerability
  in LEWZbot**, and instead to refer to our [security policy](https://rubyonrails.org/security/).
...
* Before submitting, please read the [Contributing to LEWZbot](https://edgeguides.rubyonrails.org/contributing_to_ruby_on_rails.html) guide to know more about coding conventions and benchmarks.

#### **Did you fix whitespace, format code, or make a purely cosmetic patch?**

Changes that are cosmetic in nature and do not add anything substantial to the stability, functionality, or testability of LEWZbot will generally not be accepted (read more about [our rationales behind this decision](https://github.com/rails/rails/pull/13771#issuecomment-32746700)).
...
* Ask any question about how to use LEWZbot in the [rubyonrails-talk mailing list](https://discuss.rubyonrails.org/c/rubyonrails-talk).

#### **Do you want to contribute to the LEWZbot documentation?**
...
LEWZbot is a volunteer effort. We encourage you to pitch in and join [the team](https://contributors.rubyonrails.org)!
